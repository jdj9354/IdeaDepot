...
const CODE_MIND_CHANGE_FILLING_OF_CONTENTS = 39;
const CODE_MIND_CHANGE_VALUE_OF_CONTENTS = 40;
const CODE_MIND_CHANGE_CONTENTS = "MCC";
const CODE_MIND_CHANGE_FILLING_OF_SHAPE = 42;
...
const SHAPE_VERTEX_COLOR = "#000000";
...
const CONTENTS_SERVER_ADDR = "127.0.0.1";
const CONTENTS_SERVER_PORT = 53374;
...
if(typeof module != "undefined"){
	if(module != null){
		...
		module.exports.CODE_MIND_CHANGE_FILLING_OF_CONTENTS = CODE_MIND_CHANGE_FILLING_OF_CONTENTS;
		...
		module.exports.CODE_MIND_CHANGE_FILLING_OF_SHAPE = CODE_MIND_CHANGE_FILLING_OF_SHAPE;
		...
		module.exports.SHAPE_VERTEX_COLOR = SHAPE_VERTEX_COLOR;
		...
		module.exports.CONTENTS_SERVER_ADDR = CONTENTS_SERVER_ADDR;
		module.exports.CONTENTS_SERVER_PORT = CONTENTS_SERVER_PORT;

...
function ThinkMineCanvas(userDefinedDrawingInterface, userDefinedCollisionInterface){ //MindMap객체를 가지고 이객체를 DrawingObj에개 그리도록 Data ByPass
	...
	this.addMindObject = function(x, y, z, shape, contents){
		...
		fSocketHelper.fSocketDataCommuHelperSender.mindObjectCreateSend(fMindMapId,
																			x,
																			y,
																			z,
																			shape,
	...
	this.deleteMindObject = function(mindObjectId){
		...
		fSocketHelper.fSocketDataCommuHelperSender.mindObjectRemoveSend(fMindMapId,	
																		mindObjectId);
	...
	this.moveMindObject = function(mindObjectId, x, y, z){
		...
		fSocketHelper.fSocketDataCommuHelperSender.mindObjectMoveSend(fMindMapId,
																			mindObjectId,
																			x,
																			y,
																			z)};
	...
	this.connectMindObject = function (srcMindObjectId, dstMindObjectId, edgeType, edgeTypeDependentInfo){
		...
		fSocketHelper.fSocketDataCommuHelperSender.mindObjectConnectToSend(fMindMapId,
																				srcMindObjectId,
																				dstMindObjectId, 
																				edgeType,
	...
	this.disconnectMindObject  = function (srcMindObjectId, dstMindObjectId, edgeType){
		if(srcMindObjectId == null || srcMindObjectId == undefined
			...
			fSocketHelper.fSocketDataCommuHelperSender.mindObjectDisconnectFromSend(fMindMapId,
																							srcMindObjectId,
																							dstMindObjectId, 
																							edgeType);
	...
	this.changeColorOfContents = function(mindObjectId, color){
		...
		fSocketHelper.fSocketDataCommuHelperSender.mindObjectChangeColorOfContentsSend(fMindMapId,
																						 mindObjectId,
																						 color);		
	};
	...
	this.changeColorOfShape = function(mindObjectId, color){
		...
		fSocketHelper.fSocketDataCommuHelperSender.mindObjectChangeColorOfShapeSend(fMindMapId,
																						 mindObjectId,
																						 color);		
	};

...
<div id="frontpage-info-big"><?php echo get_theme_mod( 'DD_frontpage1_hello', 'Hello!' ); ?></div>
<div id="frontpage-info-desc"><?php echo get_theme_mod( 'DD_frontpage1_desc', 'BuddyPress lets users register on your site and start creating profiles, posting messages, making connections, creating and interacting in groups and much more.' ); ?></div>

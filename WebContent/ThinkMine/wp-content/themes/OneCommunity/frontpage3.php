...
<div id="banner">
	...
	<div class="oneByOne-left" data-animate="bounceInLeft">
		<div class="slider-item-1" data-animate="bounceInLeft"><?php echo get_theme_mod( 'DD_frontpage3_slider_hello', 'Hello!' ); ?></div>
		<div class="slider-item-2" data-animate="bounceInUp"><?php echo get_theme_mod( 'DD_frontpage3_slider_hello2', 'Welcome to OneCommunity' ); ?></div>
	</div>

		<div class="slider-item-3" data-animate="bounceInRight"><?php echo get_theme_mod( 'DD_frontpage3_slider_row1', 'Create profile' ); ?></div>
		<div class="slider-item-4" data-animate="bounceInRight"><?php echo get_theme_mod( 'DD_frontpage3_slider_row2', 'Find friends' ); ?></div>
		<div class="slider-item-5" data-animate="bounceInRight"><?php echo get_theme_mod( 'DD_frontpage3_slider_row3', 'Post messages' ); ?></div>
		<div class="slider-item-6" data-animate="bounceInRight"><?php echo get_theme_mod( 'DD_frontpage3_slider_row4', 'Make connections' ); ?></div>
	</div><!-- oneByOne_item -->


	<div class="oneByOne_item oneByOne-slide-2">
	<div class="oneByOne-a" data-animate="bounceInLeft"><?php echo get_theme_mod( 'DD_frontpage3_2nd_slide', '34.000 Members' ); ?></div>
	</div><!-- oneByOne_item -->


	<div class="oneByOne_item oneByOne-slide-3">
	<div class="oneByOne-b" data-animate="bounceInUp"><?php echo get_theme_mod( 'DD_frontpage3_3rd_slide', '25 Active Groups' ); ?></div>
	</div><!-- oneByOne_item -->

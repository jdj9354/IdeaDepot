<tr>
	...
	<div class="post-author"><?php do_action( 'bbp_theme_before_reply_author_details' ); ?>
		...
		<?php _e( 'Topics', 'OneCommunity' ); ?>: <?php echo  bbp_get_user_topic_count_raw(bbp_get_reply_author_id()); ?>
		<?php _e( 'Replies', 'OneCommunity' ); ?>: <?php echo bbp_get_user_reply_count_raw(bbp_get_reply_author_id()); ?>
		</div>
	...
	<p class="topic-meta"><a id="post-<?php bbp_reply_id(); ?>" href="<?php bbp_reply_url(); ?>" title="<?php bbp_reply_title(); ?>"><?php bbp_reply_post_date(); ?></a>

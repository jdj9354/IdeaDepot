	...
	<td class="forum-topic-cell">
		...
		<?php _e('Started by', 'OneCommunity'); ?> <?php printf( bbp_get_topic_author_link( array( 'type' => 'name' ) ) ); ?> <?php bbp_reply_post_date(); ?>
			...
			<?php if ( !bbp_is_single_forum() || ( bbp_get_topic_forum_id() != bbp_get_forum_id() ) ) : ?>
				...
				<span class="bbp-topic-started-in"><?php  _e( 'in',  'OneCommunity' ); ?> <a href="<?php echo bbp_get_forum_permalink( bbp_get_topic_forum_id() ) ?>"><?php echo bbp_get_forum_title( bbp_get_topic_forum_id() ); ?></a></span>

...
<div id="container">
	...
	<div class="page-title"><?php _e('Create an account', 'OneCommunity'); ?></div>
		...
		<div class="page" id="register-page">
			...
			<div class="register-section" id="basic-details-section">
				...
				<div class="submit">
				<?php
				$registration_disable = get_theme_mod( 'DD_registration_disable', false );
				if ( $registration_disable == true ) { ?>
				<div id="signup_submit"><?php echo get_theme_mod( 'DD_registration_disable_title', 'Registration Disabled' ); ?></div>
				<?php } else { ?>

...
$number_of_comments = 'Recent Comments';
}
...
$wp_customize->add_section( 'DD_logo_section' , array(
    'title'       => 'Logo & Favicon',
    'priority'    => 30,
    'description' => 'Upload your logo and favicon. Recommended size of logo is 300px x 93px and favicon - 16px x 16px. Your favicon must have .gif extension and changes will be visible when you clear the cache of your web browser.',
) );

$wp_customize->add_setting( 'DD_logo' );
...
$wp_customize->add_setting( 'DD_favicon' );

$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'DD_favicon', array(
    'label'    => 'Favicon',
    'section'  => 'DD_logo_section',
    'settings' => 'DD_favicon',
) ) );
...
$wp_customize->add_section( 'DD_stats_section' , array(
    'title'       => 'Google Analytics',
    'priority'    => 100,
    'description' => 'Paste tracking code of Google Analytics.',
) );

$wp_customize->add_setting( 'DD_stats' );

$wp_customize->add_control( 'DD_stats', array(
    'type'     => 'textarea',
    'priority' => 100,
    'section'  => 'DD_stats_section',
    'settings' => 'DD_stats',
...
$wp_customize->add_section( 'DD_frontpage1_info_section' , array(
    'title'       => 'Frontpage 1 Information',
    'priority'    => 31,
) );

$wp_customize->add_setting( 'DD_frontpage1_hello' , array(
    'default' => 'Hello!',
) );

$wp_customize->add_control( 'DD_frontpage1_hello', array(
    'type'     => 'text',
    'priority' => 100,
    'section'  => 'DD_frontpage1_info_section',
    'settings'  => 'DD_frontpage1_hello',
    'label'    => 'Put some welcome message like `Hello!`.',
) );

$wp_customize->add_setting( 'DD_frontpage1_desc' , array(
    'default' => 'BuddyPress lets users register on your site and start creating profiles, posting messages, making connections, creating and interacting in groups and much more.',
) );

$wp_customize->add_control( 'DD_frontpage1_desc', array(
    'type'     => 'textarea',
    'priority' => 100,
    'section'  => 'DD_frontpage1_info_section',
    'settings'  => 'DD_frontpage1_desc',
    'label'    => 'Put some information about your website here.',
) );
...
$wp_customize->add_section( 'DD_frontpage3_slider_section' , array(
    'title'       => 'Frontpage 3 Slider',
    'priority'    => 31,
    'description' => 'Edit slider on the Frontpage 3',
) );

$wp_customize->add_setting( 'DD_frontpage3_slider_hello' , array(
    'default' => 'Hello!',
) );

$wp_customize->add_control( 'DD_frontpage3_slider_hello', array(
    'type'     => 'text',
    'priority' => 1,
    'section'  => 'DD_frontpage3_slider_section',
    'settings'  => 'DD_frontpage3_slider_hello',
    'label'    => 'Put some welcome message like `Hello!`.',
) );



$wp_customize->add_setting( 'DD_frontpage3_slider_hello2' , array(
    'default' => 'Welcome to OneCommunity',
) );

$wp_customize->add_control( 'DD_frontpage3_slider_hello2', array(
    'type'     => 'text',
    'priority' => 2,
    'section'  => 'DD_frontpage3_slider_section',
    'settings'  => 'DD_frontpage3_slider_hello2',
    'label'    => 'Put 2nd welcome message like `Welcome to OneCommunity`.',
) );


$wp_customize->add_setting( 'DD_frontpage3_slider_row1' , array(
    'default' => 'Create profile',
) );

$wp_customize->add_control( 'DD_frontpage3_slider_row1', array(
    'type'     => 'text',
    'priority' => 3,
    'section'  => 'DD_frontpage3_slider_section',
    'settings'  => 'DD_frontpage3_slider_row1',
    'label'    => 'Put some text here.',
) );


$wp_customize->add_setting( 'DD_frontpage3_slider_row2' , array(
    'default' => 'Find friends',
) );

$wp_customize->add_control( 'DD_frontpage3_slider_row2', array(
    'type'     => 'text',
    'priority' => 4,
    'section'  => 'DD_frontpage3_slider_section',
    'settings'  => 'DD_frontpage3_slider_row2',
    'label'    => 'Put some text here.',
) );


$wp_customize->add_setting( 'DD_frontpage3_slider_row3' , array(
    'default' => 'Post messages',
) );

$wp_customize->add_control( 'DD_frontpage3_slider_row3', array(
    'type'     => 'text',
    'priority' => 5,
    'section'  => 'DD_frontpage3_slider_section',
    'settings'  => 'DD_frontpage3_slider_row3',
    'label'    => 'Put some text here.',
) );


$wp_customize->add_setting( 'DD_frontpage3_2nd_slide' , array(
    'default' => 'Post messages',
) );

$wp_customize->add_control( 'DD_frontpage3_2nd_slide', array(
    'type'     => 'text',
    'priority' => 6,
    'section'  => 'DD_frontpage3_slider_section',
    'settings'  => 'DD_frontpage3_2nd_slide',
    'label'    => '34.000 Members',
) );


$wp_customize->add_setting( 'DD_frontpage3_2nd_slide' , array(
    'default' => '34.000 Members',
) );
...
$wp_customize->add_setting( 'DD_frontpage3_3rd_slide' , array(
    'default' => '25 Active Groups',
) );

$wp_customize->add_control( 'DD_frontpage3_3rd_slide', array(
    'type'     => 'text',
    'priority' => 7,
    'section'  => 'DD_frontpage3_slider_section',
    'settings'  => 'DD_frontpage3_3rd_slide',
    'label'    => '25 Active Groups',
) );

//////////////////////////////////////////////////////////////////


$wp_customize->add_section( 'DD_bar_section' , array(
    'title'       => 'Admin bar',
    'priority'    => 31,
) );

$wp_customize->add_setting( 'DD_bar' );

$wp_customize->add_control( 'DD_bar', array(
    'type'     => 'checkbox',
    'priority' => 100,
    'section'  => 'DD_bar_section',
    'settings'  => 'DD_bar',
    'label'    => 'Hide admin bar on website.',
) );
...
$wp_customize->add_setting( 'DD_registration_disable' );
...
$wp_customize->add_setting( 'DD_color_scheme' );
...
$wp_customize->add_setting( 'DD_tile_groups_icon' );
...
$wp_customize->add_setting( 'DD_tile_forum_icon' );
...
$wp_customize->add_setting( 'DD_tile_blog_icon' );
...
$wp_customize->add_setting( 'DD_tile_members_icon' );
...
$wp_customize->add_setting( 'DD_tile_activity_icon' );
...
$wp_customize->add_setting( 'DD_tile_about-us_icon' );
...
$baroption = get_theme_mod( 'DD_bar', false );
if ( $baroption == true && !is_admin() ) {

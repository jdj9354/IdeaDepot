...
class colorBlock extends maxBlock 
{
	...
	protected $fields = array("text_color" => array("default" => "#ffffff",
						...
						"text_shadow_color" => array("default" => "#618926",
													"css" => "text-shadow-color",
													"csspart" => "mb-text"
													),
						"gradient_start_color" => array("default" => "#98ba40",
													"css" => "gradient-start-color"
													),
						"gradient_end_color" => array("default" => "#618926",
													"css" => "gradient-end-color"
													), 
						"border_color" => array("default" => "#618926",
													"css" => "border-color"
												    ),
						"box_shadow_color" => array("default" => "#333333",
													"css" => "box-shadow-color"
													),
						"text_color_hover" => array("default" => "#ffffff",
													"css" => "color", 
													"csspart" => "mb-text",
													"csspseudo" => "hover", 
													),
						"text_shadow_color_hover" => array("default" => "#12295d",
													"css" => "text-shadow-color", 
													"csspart" => "mb-text",
													"csspseudo" => "hover"),
													
						"gradient_start_color_hover" => array("default" => "#2270df",
													"css" => "gradient-start-color", 
													"csspseudo" => "hover"),
													
						"gradient_end_color_hover" => array("default" => "#12295d",
													"css" => "gradient-end-color", 
													"csspseudo" => "hover"
													),
													
						"border_color_hover" => array("default" => "#0f2557",
													"css" => "border-color", 
													"csspseudo" => "hover"),	
	...
	public function admin_fields() 
	{
		...
		$color_labels = array(__("Text","maxbuttons"),  
							  sprintf(__('Text%sShadow', 'maxbuttons'),'<br />'), 
							  sprintf(__('Gradient%sStart', 'maxbuttons'), '<br />'),
							  sprintf(__('Gradient%sEnd', 'maxbuttons'), '<br />'),
							  __('Border', 'maxbuttons'),
							  sprintf(__('Border%sShadow', 'maxbuttons'), '<br />')
							  ); 
							  
		$normal_colors = array("text_color", "text_shadow_color", "gradient_start_color", "gradient_end_color", "border_color", "box_shadow_color");
		$hover_colors = array("text_color_hover", "text_shadow_color_hover", "gradient_start_color_hover", "gradient_end_color_hover", 
		"border_color_hover", "box_shadow_color_hover" ); 
							...
							<table class="color-line" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<?php foreach($normal_colors as $color) 
									{
										?>
									<td>
										<span class="colorpicker-box" id="<?php echo $color ?>_box">
											<span></span>
										</span>
